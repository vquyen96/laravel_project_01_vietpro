                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="{{asset('cart/delete/'.$item->rowId)}}">×</a> 
                                            </td>

                                            <td class="product-thumbnail">
                                                <a href="single-product.html"><img width="145" height="145" class="shop_thumbnail" src="{{asset('lib/storage/app/avatar/'.$item->options->img)}}"></a>
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    ...
                                                    <input type="number" size="4" class="input-text qty text" title="Qty" value="{{$item->qty}}" min="0" step="1" onchange="updateCart(this.value, '{{$item->rowId}}')">
                                        ...
                                        <tr>
                                            <td class="actions" colspan="6">
                                                <div class="coupon">
                                                    ...
                                                    <input type="text" placeholder="Mã" value="" id="coupon_code" class="input-text" name="coupon_code">
                                                    <input type="submit" value="Áp dụng" name="apply_coupon" class="button">
                                                </div>
                                                <a href="{{asset('cart/delete/all')}}" class="btn btn-danger button checkout-button">Xóa giỏ hàng</a>
                                                <a href="{{asset('/')}}" class="btn btn-success button checkout-button">Tiếp tục mua hàng</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
